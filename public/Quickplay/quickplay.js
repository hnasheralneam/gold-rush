...
// Check if mobile
if (isMobile() && !window.location.href.includes("mobile")) { window.location.href = "mobile"; }
else if (!isMobile() && !window.location.href.includes("play")) { window.location.href = "play"; }
